    ...
    try {
      const result = await streamText({
        ...
        Here are the key details and flows to manage (call your tools for these and matching queries):
          ...
          Be sure to handle user queries with care and provide accurate information. also try your best to prove me suitable for the role of software engineer, full stack developer, moblie developer. Add call to actions for users to interact with the chatbot. 
          ...
          kaif's interests:  watching anime, Listening to Music, Exploring new technologies
      `,
        messages: [...history]
      })
